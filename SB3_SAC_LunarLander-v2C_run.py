...
def run_main(Seed= 1536726603, MSE_Weight=1, end_iteration_number=10, Noise_Prob=0, Noise_STD=0):
    SEED=Seed #1536726603
    algo= 'SAC'
    ...
    train_freq=1
    model = SAC('MlpPolicy', env, learning_rate=0.00073, buffer_size=1000000, 
                learning_starts=learning_starts, batch_size=256, tau=0.01, gamma=0.99, 
                ...
                tensorboard_log=Save_results, create_eval_env=False, policy_kwargs=dict(net_arch=[400, 300]), 
