...
def run_main(Seed= 1, MSE_Weight=1, end_iteration_number=10, SIGMA=0, MU=0):
    ...
    model = SAC('MlpPolicy', env, learning_rate= 0.001, buffer_size=1000000, 
                 ...
                 start_iteration_number=start_iteration_number , end_iteration_number=end_iteration_number, SIGMA=SIGMA, MU=MU) #newline
