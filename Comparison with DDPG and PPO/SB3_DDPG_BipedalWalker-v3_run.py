...
def run_main(Seed= 1493355531, algo= 'DDPG', envname='BipedalWalker-v3', Adaptive_Beta=True, Just_Beta = True, MSE_Weight=1, Initial_Beta=1,  start_iteration_number=0 , end_iteration_number=10, SIGMA=0, MU=0):
    SEED=Seed 
