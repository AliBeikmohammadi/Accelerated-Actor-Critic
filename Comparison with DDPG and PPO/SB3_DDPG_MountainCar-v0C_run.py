...
def run_main(Seed= 2228253929, algo= 'DDPG', envname='MountainCarContinuous-v0', Adaptive_Beta=True, Just_Beta = True, MSE_Weight=1, Initial_Beta=1,  start_iteration_number=0 , end_iteration_number=10, Noise_Prob=0, Noise_STD=0):
