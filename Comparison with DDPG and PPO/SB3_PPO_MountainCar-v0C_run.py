...
def run_main(Seed= 2228253929, algo= 'PPO', envname='MountainCarContinuous-v0', Adaptive_Beta=True, Just_Beta = True, MSE_Weight=1, Initial_Beta=1,  start_iteration_number=0 , end_iteration_number=10, Noise_Prob=0, Noise_STD=0):
    SEED=Seed 
    ...
    env = make_vec_env(envname, n_envs=1, seed=SEED, start_index=0, monitor_dir=None, wrapper_class=None, 
    ...
    env = VecNormalize(env, training=True, norm_obs=True, norm_reward=False, 
                      clip_obs=10.0, clip_reward=10.0, gamma=0.9999, epsilon=1e-08, norm_obs_keys=None) #gamma should be same, norm_reward=False
    ...
    model = PPO('MlpPolicy', env, learning_rate=0.0000777, n_steps=n_steps, batch_size=256, n_epochs=10, gamma=0.9999, gae_lambda=0.9, 
                clip_range=0.1, clip_range_vf=None, normalize_advantage=True, 
                ent_coef=0.00429, vf_coef=0.19, max_grad_norm=5, use_sde=True, sde_sample_freq=-1, 
